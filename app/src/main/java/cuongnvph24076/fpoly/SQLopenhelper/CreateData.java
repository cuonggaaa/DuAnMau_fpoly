package cuongnvph24076.fpoly.SQLopenhelper;
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tb_tv =
                "create table ThanhVien (" +
                        ...
                        "hoTen TEXT NOT NULL, " +
                        "namSinh TEXT NOT NULL, taiKhoan INTEGER NOT NULL)";
        db.execSQL(tb_tv);
        //Bảng Loại sách
        String tb_ls =
        ...
        String tb_S =
                "create table Sach (" +
                        ...
                        "maLoai INTEGER REFERENCES LoaiSach(maLoai), luotMua INTEGER, soLuong INTEGER not null)";
        db.execSQL(tb_S);
        //Bảng Phiếu Mượn
        String tb_pm =
